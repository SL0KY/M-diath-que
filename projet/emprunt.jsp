	...
	<body>
		...
		<div class="container-fluid">
			<div class="row justify-content-center">
				<div class="col-12">
					<h1 style="margin-top: 80px" class="text-center">Bienvenue <% out.println(login); %> sur votre espace d'emprunt</h1>
				</div>
				<div class="col-md-4">
					<h3 class="text-center">Emprunter un document</h3>
					<%
						if(request.getParameter("success") != null)
						{
							...
							{
								out.println("<p class='text-center success'>Votre document à bien été emprunté</p>");
							}
					...
					%>
					<form method="post" action="empruntConfirmation.jsp">
							...
							<option value="-1">--Sélectionner--</option>
								...
								if(docs != null)
								{
									for(int i = 0; i < docs.size(); ++i)
									{
										...
										if(eDoc.affiche()[2].equals("Disponible"))
										{
